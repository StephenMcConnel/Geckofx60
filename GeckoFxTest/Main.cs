...
namespace GeckoFxTest
{
	class MainClass
	{
		...
		public static void Main(string[] args)
		{
			...
			string xulrunnerPath = XULRunnerLocator.GetXULRunnerLocation(XULRunnerLocator.GeckoHintPath("0.19.0"));
			...
			// GeckoPreferences.User["intl.complexLineBreaking.uniscribe"] =  true;
