...
Rebuild to increment file version numbers.
...
Linux build.
1. Fix regressions caused by last changes
...
Linux build.
1. Fix use of gtk2 api when GtkDontUseSetInputFocus is set to true.
...
1. Fix some black windows problems on 18.04 systems.

== v60.0-0.29 ==

Linux build. 

1. Collection of small Linux bug fixes.

== v60.0-0.27 ==

Linux build. 

1. Attempt at Fixing blank windows in 18.04
...
2. Fix stale RCW exception when accessing GeckoWebBrowser::Window property.
